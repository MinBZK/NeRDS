...
=== "Beleidsmaker"
    ...
    **Stappen:**
    ...
    4. **Stakeholder betrokkenheid** - Organiseer consultaties met ICT-sector en burgers
...
=== "Bestuurder"
    ...
    **Stappen:**
    ...
    4. **Budgeteer voor verduurzaming** - Reserveer middelen voor groene technologie-investeringen
    ...
    **Concrete acties:**
    ...
    - Certificeer volgens ISO 14001 milieumanagementsysteem
...
=== "Projectleider"
    ...
    **Stappen:**
    ...
    4. **Monitor implementatie** - Track voortgang duurzaamheidsdoelstellingen
    ...
    **Concrete acties:**
    ...
    - Stel projectspecifieke CO2-reductiedoelen
...
=== "Developer"
    ...
    **Stappen:**
    ...
    4. **Kies duurzame architectuur** - Ontwerp voor efficiënte cloud-native deployment
    5. **Automatiseer optimalisatie** - Implementeer auto-scaling en resource scheduling

    **Code-voorbeeld - Energy-efficient Python:**
    ```python
    # Energie-efficiënte database query
    import asyncio
    from sqlalchemy import select
    from sqlalchemy.orm import selectinload

    async def get_users_efficiently():
        # Gebruik async voor I/O efficiency
        async with async_session() as session:
            # Eager loading voorkomt N+1 queries
            result = await session.execute(
                select(User)
                .options(selectinload(User.profile))
                .limit(100)  # Pagineer voor geheugenefficiëntie
            )
            return result.scalars().all()

    # Batch processing voor grote datasets
    def process_large_dataset(data):
        batch_size = 1000  # Optimale batch size
    ...
    spec:
      ...
      template:
        spec:
          containers:
          - name: app
            image: rijksoverheid/green-app:latest
            resources:
              requests:
                memory: "256Mi"
                cpu: "250m"
          ...
          # Gebruik node affinity voor energy-efficient nodes
          affinity:
            nodeAffinity:
    ...
    **Belangrijke overwegingen:**
    ...
    - Monitor carbon footprint van cloud deployments
...
=== "Jurist"
    ...
    **Stappen:**
    ...
    4. **Due diligence leveranciers** - Evalueer milieurisico's in supply chain
    ...
    **Concrete acties:**
    ...
    - Monitor wijzigingen in milieuwetgeving
...
=== "Inkoper"
    ...
    **Stappen:**
    ...
    4. **Circulaire inkoop** - Prioriteer refurbished, lease en service-modellen
    ...
    **Concrete acties:**
    ...
    - Monitor supply chain carbon footprint
