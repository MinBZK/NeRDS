...
- **Kosteneffectiviteit**: Hergebruik bestaande middelen in plaats van opnieuw te ontwikkelen (zie [Deel, hergebruik en werk samen](../samenwerking/index.md))
...
- **Toegankelijkheid**: Zorgt ervoor dat informatie breed beschikbaar en bruikbaar is (zie [Zorg voor toegankelijkheid en inclusie](../toegankelijkheid/index.md))
