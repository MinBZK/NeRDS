...
<div class="hero-section">
  ...
  <div class="version-badge">
    ...
    <div class="hover-info">
      <p>Deze guideline is in ontwikkeling. Alle versies ontstaan op een open manier. <a href="About-NeRDS/CONTRIBUTING/">Anyone can contribute to the improvement.</a></p>
    </div>
  </div>

  <div class="hero-cta">
    <a href="guidelines/" class="md-button md-button--primary">View all guidelines</a>
    <a href="About-NeRDS/" class="md-button md-button--secondary">About the NeRDS</a>
  </div>
</div>
...
<div class="cta-section">
  ...
  <div class="cta-buttons">
    ...
    <a href="About-NeRDS/CONTRIBUTING/" class="md-button md-button--secondary">Contribute to NeRDS</a>
  </div>
</div>
