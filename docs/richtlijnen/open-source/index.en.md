...
4. **Document thoroughly**: Make it easy for others to understand and contribute your code
5. **Build a community**: Encourage contributions and feedback to your projects (see [Deel, hergebruik en werk samen](../samenwerking/index.md))

### Benefits of publishing your own code

- **Better documentation**: Encourages clearer documentation
- **Clean code**: Leads to cleaner, more maintenanceable code
- **Data safety**: Provides clarity around protected data
- **Improvement**: Creates opportunities for suggestions for improvement

### Considerations when choosing open source technology

- **Does it meet user needs?** Does the solution meet the specific requirements?
...
- **Is it sufficiently secure?** Check safety history and update frequency
- **Is the license acceptable?** Understand licensing terms and obligations
...
### Recommended license for government projects

For Dutch public projects, the **European Union Public Licence (EUPL v1.2)** is recommended. This licence:

- Has been specifically developed for European government software
- Is legally validated in all EU languages
- Has a "weak reciprocal" character (changes to the original code must be shared under the same license)
- Is compatible with other popular open source licenses
- Meets the open source definition

When publishing public code, it is advisable to use the EUPL-1.2 unless there are specific reasons to choose another license. See the [OSPO-NL kennisbank over OSS-licenties](https://ospo-nl.github.io/kennisbank/best-practices/open-source-software-licenties/) for more information about license types and considerations.

## Related Tools

- [Opensourcewerken community](https://developer.overheid.nl/communities/open-source-werken) - Community of the Ministry of the Interior for practical knowledge, a forum for sharing experiences and working on relevant regulations for open source.
...
- [Instructie Rijksdienst bij aanschaf ICT-diensten of ICT-producten](https://wetten.overheid.nl/BWBR0024717/2008-11-23) - Official instruction requiring open standards to be required by the Government when purchasing ICT services or products.
