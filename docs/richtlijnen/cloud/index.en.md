...
<div class="form__row'>
<label class="form__label' for="cluster-region'>
...
<p class="cluster-spinner-text">Kubernetes cluster is created. </ p>
</div>
...
<a href="https://haven.commonround.nl/" class="action-button" target="_white">Discover</a>
</div>
<div class="action-card'>
<span class="wip-badge-badge-available">available</span>
<h4 >Azure Bio-Compliancy</h4>
<p >Cloud compliance for government organisations</p>
<a href="https://github.com/Azure/Bio-Compliancy" class="action-button" target="_white">Discover</a>
</div>
<div class="action-card'>
<span class="wip-badge wip-badge development">development</span>
