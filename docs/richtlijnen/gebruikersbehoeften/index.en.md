...
summary: Understand your users and their needs. Develop knowledge about your users and what that means for your technology project.
relations:
  - toegankelijkheid
  - privacy
  - servicestandaard
...
- **Prevent costly errors:** Build the right solution from the start instead of adjusting afterwards
- **Increased adoption:** Users embrace systems that solve their actual problems
...
- **Improve service:** Systems that match user needs work more effectively
- **Support internal alignment:** Create agreement on technology objectives within teams

By applying a user-oriented approach to technology development and implementation in public services, you increase the acceptance and effectiveness of digital public services while strengthening trust between citizens and government.
...
<a href="https://toolkitaal.usercentral.nl/directives/" class="action-button" target="_white">View</a>
</div>
</div>
</div>
...
- Risks of introducing or changing technology
...
1. Perform a thorough user survey
