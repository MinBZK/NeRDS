...
- **Efficient processes**: Identify bottlenecks and optimise workflows
...
<a href="https://data.government.en/" class="action-button" target="_white">Explore</a>
</div>
<div class="action-card'>
...
<a href="https://digilab.government.nl/projects/synthetic-datageneration/"class="action-button" target="_white">Learn</a>
</div>
</div>
</div>
...
- **Data inventory**: Identify what data is available
...
- **Analytics capacity**: Build capacity for data analysis
...
- **Datasilios**: Promote organisational cooperation
...
- *Skill shortages**: Invest in training and expertise
...
- **[Uit Betrouwbare Bron](https://digilab.overheid.nl/projecten/)***: Initiative aimed at data quality in federative data systems, with emphasis on the 'data at source' directive.
...
- **[data.overheid.nl](https://data.overheid.nl/)***: The open data portal of the Dutch government, which provides access to datasets of government organizations.
