...
summary: Build technology that uses open standards to make sure your technology works and communicates with other technology.
relations:
  - integratie
  - toegankelijkheid
  - open-source
...
- **Transparency:** Promotes openness of government systems
...
<a href="https://www.forumstandardization.nl/decisiontree/decisiontree-open-standards" class="action-button" target="_white">Start</a>
</div>
<div class="action-card'>
<span class="wip-badge-badge-available">available</span>
<h4 >API Standards</h4>
<p >Dutch API strategy</p>
<a href="https://docs.geostandarden.nl/api/API-Strategy/" class="action-button" target="_white">View</a>
</div>
<div class="action-card'>
<span class="wip-badge-badge-available">available</span>
<h4 >Developer General government APIs</h4>
<p >Overview of government APIs</p>
<a href="https://apis.developer.government.en/apis" class="action-button" target="_white">Discover</a>
</div>
<div class="action-card'>
...
- Implement RESTful APIs: Develop by [NL API Strategie](https://docs.geostandaarden.nl/api/API-Strategie/) and __PRESERVE_3_
- Avoid data duplication: Use unique data sources
- Document with OpenAPI: Make API documentation available via Developer Government
- Validere and maintenance: Test conformity and monitor standard developments
...
Are there enough implementations available?
- **Strategic value:**
...
- **Quick change**: Keep up to date on new developments
- **Find Balans**: Weigh new standards against proven solutions

## Related standards

The [Forum Standaardisatie](https://www.forumstandaardisatie.nl/) advises the Dutch government on the use of open standards and manages the 'pass or explain' list of mandatory open standards for the public sector. Use the [Beslisboom Open Standaarden](https://www.forumstandaardisatie.nl/beslisboom/beslisboom-open-standaarden) to determine which standards apply in your situation.
...
- **[Haven](https://digilab.overheid.nl/projecten/)***: Standard for platform-independent cloud hosting, designed for reusable applications
...
- **[RSGB/RGBZ](https://www.gemmaonline.nl/wiki/Hoofdpagina)**: Basic data standards for municipalities
- **RDF**: Resource Description Framework for linked data
- **GeoJSON**: Open default for geographic data
