...
summary: Your technology must work with existing technologies, processes and infrastructure in your organisation.
relations:
  - open-standaarden
  - servicestandaard
  - samenwerking
...
- **Usage experience**: Create a coherent experience for end users
- **Data flows**: Ensure consistent and reliable data exchange
...
2. **Identify integration points**: Determine where to connect new systems
...
5. **Plan staged**: Implement changes gradually to reduce risks
...
- **Hybride cloud**: Combination of on-premise and cloud solutions
...
- **[Common Ground](https://commonground.nl/)**: A new information vision for modern data exchange within the government. Common Ground works with reusable components and the directive of 'data at source' to prevent silo formation and achieve flexible, modular IT solutions.
