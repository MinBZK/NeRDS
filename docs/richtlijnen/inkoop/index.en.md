...
summary: Your purchasing strategy must show that you have considered commercial and technological aspects.
relations:
  - duurzaamheid
  - cloud
  - open-source
...
- stimulate innovation**: Create space for new solutions and providers
...
- **Law and regulation**: Compliance with procurement rules and other rules
...
<a href="https://minbzk.github.io/Algorithmframe/subjects/public procurement/"class="action-button" target="_white">Explore</a>
</div>
</div>
</div>
...
1. **Require analysis**: Understand user needs and organisational requirements
...
- **Great vs. small suppliers**: How do you diversify your supplier portfolio?
...
- **Centrale vs. decentralised purchasing**: What is the right level of decision-making?

See also [PIANOo's richtlijnen voor Maatschappelijk Verantwoord Inkopen](https://www.pianoo.nl/nl/themas/maatschappelijk-verantwoord-inkopen/productgroepen-en-mvi-criteria) for product groups and MVI criteria that you can apply to your purchasing strategy.

## Best practices for technology procurement

- **Previous market involvement**: Talk to suppliers before formal tender
...
- **Quick technological change**: Build flexibility in contracts
- **Limited market knowledge**: Perform sound market research
- **Legacy dependencies**: Develop migration strategies
- **Balancing multiple interests**: Align with all stakeholders
