...
summary: Ensure that user rights are protected by integrating privacy as an essential part of your system.
relations:
  - veiligheid
  - data
  - algoritmen
...
- *Build confidence**: Citizens trust systems that respect their privacy
- **Risk reduction**: Prevent data leaks and privacy violations (see [Maak veilige systemen](../veiligheid/index.md))
- **Ethical responsibility**: Respect the rights and dignity of individuals
...
<a href="https://www.authority personal data.en/subjects/avg-european-privacy legislation/data-protection-impact-assessment-dpia" class="action-button" target="_blank">Download</a>
</div>
<div class="action-card'>
<span class="wip-badge-badge-available">available</span>
<h4 >Pre-scan DPIA & DPIA Form</h4>
<p >Online data protection impact assessment form</p>
<a href="https://minbzk.github.io/par-dpia-form/" class="action-button" target="_white">Start</a>
</div>
<div class="action-card'>
<span class="wip-badge wip-badge development">development</span>
<h4 >NICPET Tools</h4>
<p >Privacy-enhancing technologies</p>
<a href="https://nicpet.pleio.nl/" class="action-button" target="_white">Explore</a>
</div>
<div class="action-card'>
...
Are you collecting new personal information?
...
- Did the data contain any sensitive personal details?

### Key Guidelines of Privacy by Design

1. **Proactive, not reactive**: Avoid privacy problems before they arise
...
4. **Full functionality**: Avoid false contradictions such as privacy vs. security
...
- **Admission**: Provide valid consent where necessary
- **Savements**: Define and implement data retention policies
...
- **Pseudonimization**: Remove instantly identifying elements
- **Anonymization**: Make data un redirectable where possible
- **Access control**: Implement the directive of least privilege
- **Privacy monitoring**: Detect and respond to privacy issues

## Related Tools

- Consult the Authority Personal Data Guidelines
- See GDPR regulations
- Use Data Protection Impact Assessment (DPIA) templates
- [Handreiking Mobiele app Ontwikkeling en Beheer versie 4.0](https://www.noraonline.nl/images/noraonline/2/26/Handreiking_Mobiele_App_4.0.pdf) - Chapter 3.2 uses the privacy by design guidelines for developing a mobile app.
