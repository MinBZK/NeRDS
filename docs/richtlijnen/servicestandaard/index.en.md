...
summary: If you are building a service as part of your technology project or program, you must also comply with the Service Standard.
relations:
  - gebruikersbehoeften
  - toegankelijkheid
  - integratie
...
- **Confidence**: Strengthens citizens' confidence in digital public services
- **Continu improve**: Encourages continuous improvement of services
...
<a href="https://endesignsystem.nl" class="action-button" target="_white">Explore</a>
</div>
<div class="action-card'>
...
- Examine who your users are and what they want to achieve
- Validate assumptions with user survey
- Keep collecting and processing user feedback

### 2. Solve whole problems

- Focus on the full user journey, not just the digital part
- Work across organisational boundaries
- Avoid isolated solutions that do not fit into the wider context
...
- Encourage close cooperation rather than sequential transfer

#### 4. Create and iterate with users

- Developing services incrementally
...
- **Independent check**: Have your service evaluated by experts
- **Continu improve**: Use reviews to improve services
- **Publication of results**: Transparency on how services perform

### Implementation in practice

- Start the service standard from the start of the project
- Document how you meet the standard
