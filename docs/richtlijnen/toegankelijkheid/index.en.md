...
- **Legal obligation**: Overheidsorganisaties zijn wettelijk verplicht om hun digitale diensten toegankelijk te maken
- **Better for everyone**: Toegankelijke diensten zijn meestal eenvoudiger en gebruiksvriendelijker voor iedereen
- **Increase range**: Je bereikt een breder publiek en zorgt dat niemand wordt uitgesloten
- **Cost effectiveness**: Toegankelijkheid vanaf het begin inbouwen is goedkoper dan achteraf aanpassen
- **Staff support**: Stelt alle medewerkers in staat om de benodigde infrastructuur te gebruiken
- **Avoid legal challenges**: Voorkom potentiële juridische problemen door niet-toegankelijke technologie
...
- [Kennisbank Digitoegankelijk](https://kennisbank.digitoegankelijk.nl) - Praktische tips over digital accessibility

## Related Guidelines

- [1. Understand user needs](../gebruikersbehoeften/index.md)
- [4. Gebruik open standaarden](../open-standaarden/index.md)
- [14. Meet the service standard](../servicestandaard/index.md)
