...
summary: Make sure your technology, infrastructure and systems are accessible and inclusive to all users.
relations:
  - gebruikersbehoeften
  - servicestandaard
  - open-standaarden
...
Accessibility is about creating services and systems that can be used by everyone, including people with disabilities or specific needs. This Directive ensures that all citizens have equal access to public services.
...
- **Grow reach**: You reach a wider audience and make sure no one is excluded
- **Cost effectiveness**: Accessibility from the start is cheaper than adjusting afterwards
- **Supporting staff**: Allows all employees to use the necessary infrastructure
- **Avoid legal challenges**: Avoid potential legal problems due to inaccessible technology
...
- Follow web guidelines (WCAG 2.2 AA standard minimum)
...
- Make sure future updates retain accessibility

### Important considerations

- Make systems work with different input methods (keyboard, mouse, touch screen, voice)
- Note color contrast for people with visual limitations
...
- [EN 301 549](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf) (European standard for hardware/non-web software)
