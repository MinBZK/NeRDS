...
summary: Avoid duplication and unnecessary costs by working together within the government and by sharing and reusing technology.
relations:
  - open-source
  - integratie
  - duurzaamheid
...
- **Quicker implementation**: Accelerate projects by using existing components
...
By actively cooperating, sharing knowledge and reusing existing solutions, the government can work more efficiently, save costs and provide more consistent services to citizens and businesses.
...
2. **Document good**: Clarify how something can be reused
3. **Build communities**: Create platforms for cooperation
4. **Stimulate reuse**: Make it more attractive to reuse than rebuild
5. **Four successes**: Part examples of successful cooperation
6. **Involvement of stakeholders**: Include various perspectives
...
- **APIs**: Data exchange interfaces (see [Integreer en pas technologie aan](../integratie/index.md))
- **Datasets**: Data useful for multiple organisations (see [Maak beter gebruik van data](../data/index.md))
- **Contracts and invitations to tender**: Templates and frameworks (see [Definieer je inkoopstrategie](../inkoop/index.md))
- **Knowledge and documentation**: Best practices, manuals and guidelines
- **Methodologies**: Processes and practices

### Challenges and solutions

- **Not-invented syndrome**: Promote the benefits of reuse
- **Government**: Develop clear responsibilities for shared resources
- *Various priorities**: Find common goals
...
- Collaboration sessions and hackathons
...
## UK Government Digital Service: Experiences of the UK government

The [UK Government Digital Service (GDS)](https://www.gov.uk/government/organisations/government-digital-service) is the digital center of the British government, responsible for defining, guiding and delivering the vision for a modern digital government. Since 2011, GDS has been pioneering in digital transformation and has developed comprehensive sources and guidelines for reducing risks in digital government projects.

### Main concepts

1. **Digital by Default Strategy**

- Put user needs at the centre of service design
...
- "Start with user needs" as a fundamental directive
- Regular user tests and iteration
- Data-driven decision-making

### GDS guidelines and methods

GDS uses proven [design richtlijnen](https://www.gov.uk/guidance/government-design-principles) that have direct application for Dutch government organisations:
...
- **Design with dates**: Use analytics and user research for decisions
- **Make it accessible**: Make sure services work for everyone
- *Iteration and improvement regularly**: Launch quickly and improve continuously
...
- *Local legislation**: Adapt methodologies for Dutch privacy and accessibility laws
...
- **Knowledge exchange**: Learn from GDS public documentation and [blog](https://gds.blog.gov.uk/)

## Related Tools

- **[Government Design Principles](https://www.gov.uk/guidance/government-design-principles)**: Basic guidelines for public services
