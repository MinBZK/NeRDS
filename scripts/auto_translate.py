...
class PerfectTranslator:
    ...
    def _apply_dictionary(self, text: str) -> str:
        """Apply dictionary translations with longest-match-first priority and case preservation."""
    ...
    def _translate_formatted_text(self, text: str) -> str:
        ...
        # Pattern for regular links [text](url)
        ...
        # Check if any formatting patterns were found and applied
        ...
        # Check if links were found (they're now placeholders)
        links_found = bool(link_placeholders)

        # If no formatting was found and no links, translate the entire text as plain text
        if not formatting_found and not links_found:
    ...
    def _translate_html_content(self, line: str) -> str:
        """
        Translate ONLY the text content inside HTML tags, preserving all HTML structure.
        Handles formatted text within HTML tags.
        """
    ...
    def _translate_line(self, line: str) -> str:
        ...
        # Always apply dictionary to the entire line first for consistency
        line = self._apply_dictionary(line)

        # Handle lines with HTML content
